...
target the default tcp port `1433` that MSSQL listens on.
...
Connecting with mssqlclient.py - https://github.com/fortra/impacket/blob/master/examples/mssqlclient.py
```
locate mssqlclient
```
```
